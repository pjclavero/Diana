...
| P-08 | **Deriva entre lo desplegado y `develop`** (nuevo, 2026-07-26) | MEDIA | La VM corre `045fdd1` y `develop` va por `133d760`. Con el DNS y la RAM como están, redesplegar no es trivial, así que la deriva tiende a crecer. Mitigación: declarar en `STATUS.md`, en cada entrega, **qué commit corre en la VM** — no basta con decir «desplegado» |
